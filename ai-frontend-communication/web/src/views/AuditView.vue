...
<template>
  ...
  <form class="filter-bar" @submit.prevent="applyFilters"><label><span>Тип события</span><input v-model="eventType" placeholder="clarification.answered" /></label><label><span>Correlation ID</span><input v-model="correlation" placeholder="corr-..." /></label><button class="cds--btn cds--btn--sm cds--btn--primary">Применить</button></form>
